...
Edit the required value in [`config.js`](https://github.com/Rqthll/RqthllV01/blob/main/config.js)
...
// example 
conn.sendButton(m.chat, 'Hello world!', '@Rqthll', null, [
      ['Hello', 'hello'], ['Bye', 'bye']
])
// example button location
conn.sendButton(m.chat, 'Hello world!', '@Rqthll', 'https://github.com/Rqthll', 
      [['Hello', 'hello'], ['Bye', 'bye']], 
